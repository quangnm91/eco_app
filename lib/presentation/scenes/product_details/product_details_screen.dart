            ...
            body: ListView(
              ...
              children: [
                CarouselSliderComponent(
                  ...
                  images: state.productModel!.images,
                ),
                Padding(
                  padding:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(jsonDecode(state.productModel!.description ?? '')),
                      const SizedBox(height: 16),
                      Text('In stock: ${state.productModel!.quantity}'),
                      const SizedBox(height: 16),
                      state.productModel!.quantity > 0
                          ? Row(
                              children: [
                                const Text('Quantity',
                                    style: TextStyle(
                                ...
                                AdjustQuantityComponent(
                                    max: state.productModel!.quantity,
                                    onChanged: (quantity) =>
                            ...
                            builder:
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      "${(state.productModel!.price * snapshot.data)} ₫",
                                      style: const TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.w500))
                                ],
